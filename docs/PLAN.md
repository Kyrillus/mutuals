...
**Status:** approved. **Stages 1 and 2 are complete** — see §5 for what Stage 1's definition of done
actually measured, and ADR-087/088 for what Stage 2's closing section changed. Stage 3 has not started.
**Branch:** `version/claude-v1`. **Source of truth for product decisions:** [`BRIEF.md`](./BRIEF.md).
**Decision log:** [`DECISIONS.md`](./DECISIONS.md) — 89 ADRs. **Rejected designs:** `adr-archive/`.
